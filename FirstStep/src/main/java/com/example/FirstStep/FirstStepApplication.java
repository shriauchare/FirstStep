...
public class FirstStepApplication {
	...
	public Docket swaggerConfirguration() {
				...
				.apis(RequestHandlerSelectors.basePackage("com.example.FirstStep"))
				.build()
	...
	private ApiInfo apiCustomerData() {
		return new ApiInfo(
				...
				"Cloud Vendor Documention",
				"1.0",
				"Cloud Vendor Service Terms",
				new Contact("Shri", "http://StrangerShri.com", "shri@gmail.com"), 
				"Stranger Shri License", 
